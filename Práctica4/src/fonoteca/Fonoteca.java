...
public class Fonoteca {
    ...
    public Fonoteca() {
        ...
        this.recomendador = new RecomendadorPopularidad(almacenValoraciones, 0.0);
    }
    ...
    public Fonoteca(double corte) {
        ...
        almacenValoraciones = new AlmacenValoraciones();
        usuarios = new ArrayList<>();
        this.recomendador = new RecomendadorPopularidad(almacenValoraciones, corte);
    }
    ...
    public Fonoteca(RecomendadorAfinidad recomendadorAfinidad) {
        ...
        almacenValoraciones = new AlmacenValoraciones();
        usuarios = new ArrayList<>();
        this.recomendador = recomendadorAfinidad;
    ...
    public void mostrarRecomendaciones(IUsuario usuario) {
        Collection<Recomendacion> recomendaciones = this.recomendador.getRecomendaciones(usuario);
